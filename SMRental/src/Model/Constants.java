...
class Constants 
{
    ...
    public static final double EXITING_TINE = 0.1 //the average time that a customer get off the van

    public static final double DRIVER_COST = 12.5 //per hour salary of a driver
    public static final double RENTALAGENT_COST = 11.5 //per hour salary of a rental agent
